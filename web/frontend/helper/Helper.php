...
class Helper
{
    ...
    public static function sendMail($subject, $to, $body)
    {
        ...
        try {
            ...
            $mail->Username = 'thanhbnvh@gmail.com';                     //SMTP username = tài khoản mail cá nhân của bạn
            $mail->Password = 'jxtwjgxoeorkzqtk';                               //SMTP password, ko phải là mật khẩu đăng nhập của Gmail,
            ...
            //Recipients
            $mail->setFrom('thanhbnvh@gmail.com', 'From nvthanh');
