...
// Url trang danh sách sp: index.php?controller=banner&action=index
...
// -> url phân trang dạng này: index.php?controller=banner&action&page=1

class PaginationBanner
{
    ...
    //index.php?controller=banner&action&page=1
    ...
    public function getPrevPage()
    {
        ...
        if ($current_page > 1) {
            $url_prev = "index.php?controller=banner&action=index&page=" . ($current_page - 1);
            $prev_page .= "<li class='page-item'>";
            $prev_page .= "<a class='page-link' href='$url_prev'>Prev</a>";
            $prev_page .= "</li>";
        }
    ...
    public function getNextPage()
    {
        ...
        if ($current_page < $total_page) {
            $url_next = "index.php?controller=banner&action=index&page=" . ($current_page + 1);
            $next_page .= "<li class='page-item'>";
            $next_page .= "<a class='page-link' href='$url_next'>Next</a>";
            $next_page .= "</li>";
        }
    ...
    public function getPagination()
    {
        ...
        for ($page = 1; $page <= $total_page; $page++) {
            $url_page = "index.php?controller=banner&action=index&page=$page";
            $data .= "<li class='page-item'>";
            $data .= "<a class='page-link' href='$url_page'>Trang $page</a>";
            $data .= "</li>";
        }
