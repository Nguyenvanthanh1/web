...
class PaginationTest
{
    ...
    public function getPrevPage()
    {
        ...
        if ($current_page > 1) {
            $url_prev = "index.php?controller=new&action=index&page=" . ($current_page - 1);
    ...
    public function getNextPage()
    {
        ...
        if ($current_page < $total_page) {
            $url_next = "index.php?controller=new&action=index&page=" . ($current_page + 1);
    ...
    public function getPagination()
    {
        ...
        for ($page = 1; $page <= $total_page; $page++) {
            $url_page = "index.php?controller=new&action=index&page=$page";
