...
// Url trang danh sách sp: index.php?controller=new&action=index
...
// -> url phân trang dạng này: index.php?controller=new&action&page=1
...
class PaginationCategory
{
    ...
    //index.php?controller=new&action&page=1
    ...
    public function getPrevPage()
    {
        ...
        if ($current_page > 1) {
            $url_prev = "index.php?controller=category&action=index&page=" . ($current_page - 1);
    ...
    public function getNextPage()
    {
        ...
        if ($current_page < $total_page) {
            $url_next = "index.php?controller=category&action=index&page=" . ($current_page + 1);
    ...
    public function getPagination()
    {
        ...
        for ($page = 1; $page <= $total_page; $page++) {
            $url_page = "index.php?controller=category&action=index&page=$page";
